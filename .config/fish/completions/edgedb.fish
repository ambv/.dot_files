...
' -r
complete -c edgedb -n "__fish_use_subcommand" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_use_subcommand" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_use_subcommand" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
'
complete -c edgedb -n "__fish_use_subcommand" -f -a "analyze" -d 'Analyze query performance
'
...
'
complete -c edgedb -n "__fish_use_subcommand" -f -a "watch" -d 'Start a long-running process that watches for changes in schema files in your project\'s dbschema directory and applies those changes to your database in real time.
'
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from restore" -l all -d 'Restore all databases and the server configuration. [49m[39m[1mpath[0m is a directory in this case
'
...
'
complete -c edgedb -n "__fish_seen_subcommand_from configure; and __fish_seen_subcommand_from reset; and not __fish_seen_subcommand_from listen_addresses; and not __fish_seen_subcommand_from listen_port; and not __fish_seen_subcommand_from Auth; and not __fish_seen_subcommand_from shared_buffers; and not __fish_seen_subcommand_from query_work_mem; and not __fish_seen_subcommand_from maintenance_work_mem; and not __fish_seen_subcommand_from effective_cache_size; and not __fish_seen_subcommand_from default_statistics_target; and not __fish_seen_subcommand_from effective_io_concurrency; and not __fish_seen_subcommand_from session_idle_timeout; and not __fish_seen_subcommand_from session_idle_transaction_timeout; and not __fish_seen_subcommand_from query_execution_timeout; and not __fish_seen_subcommand_from allow_bare_ddl; and not __fish_seen_subcommand_from apply_access_policies; and not __fish_seen_subcommand_from allow_user_specified_id; and not __fish_seen_subcommand_from help" -f -a "maintenance_work_mem" -d 'Reset postgres configuration parameter of the same name
'
...
Some of  the operations that use this option are: vacuuming, link, index or constraint creation. If this value is specified without units, it is taken as kilobytes. It defaults to 64 megabytes (64MB).
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -s H -l host -d 'Host of the EdgeDB instance
' -r -f -a "(__fish_print_hostnames)"
...
When the supplied path is a directory, the actual path will be computed using the [49m[39m[1m--port[0m and [49m[39m[1m--admin[0m parameters.
' -r -F
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -s u -l user -d 'User name of the EdgeDB user
' -r
...
This might either be full self-signed server certificate or certificate authority (CA) certificate that server certificate is signed with.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -l tls-security -d 'Specify the client-side TLS security mode.
...
[49m[39m[1mdefault[0m: By default it\'s "strict" when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file), or "no_host_verification" otherwise.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -l wait-until-available -d 'In case EdgeDB connection can\'t be established, retry up to WAIT_TIME (e.g. \'30s\').
' -r
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -l password -d 'Ask for password on the terminal (TTY)
'
...
'
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -l tls-verify-hostname -d 'Verify hostname of the server using provided certificate

It\'s useful when certificate authority (CA) is used for handling certificate and usually not used for self-signed certificates.

By default it\'s enabled when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file)
'
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -l no-tls-verify-hostname -d 'Do not verify hostname of the server
...
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -f -a "apply" -d 'Bring current database to the latest or a specified revision
'
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -f -a "create" -d 'Create a migration script
'
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -f -a "status" -d 'Show current migration state
'
...
'
complete -c edgedb -n "__fish_seen_subcommand_from migration; and not __fish_seen_subcommand_from apply; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from status; and not __fish_seen_subcommand_from log; and not __fish_seen_subcommand_from edit; and not __fish_seen_subcommand_from upgrade-check; and not __fish_seen_subcommand_from help" -f -a "upgrade-check" -d 'Check current schema on the new EdgeDB version
'
...
This is a single step of [49m[39m[1medgedb watch[0m, when you don\'t need to monitor schema for changes.
'
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from create" -l squash -d 'Squash all migrations into one and optionally provide fixup migration.
...
' -r -f -a "(__fish_complete_directories)"
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l to-version -d 'Check the upgrade to a specified version
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l to-channel -d 'Check the upgrade to the latest version in the channel
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -s H -l host -d 'Host of the EdgeDB instance
' -r -f -a "(__fish_print_hostnames)"
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l unix-path -d 'A path to a unix socket for the EdgeDB connection

When the supplied path is a directory, the actual path will be computed using the [49m[39m[1m--port[0m and [49m[39m[1m--admin[0m parameters.
' -r -F
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -s u -l user -d 'User name of the EdgeDB user
' -r
...
This might either be full self-signed server certificate or certificate authority (CA) certificate that server certificate is signed with.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l tls-security -d 'Specify the client-side TLS security mode.
...
[49m[39m[1mdefault[0m: By default it\'s "strict" when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file), or "no_host_verification" otherwise.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l wait-until-available -d 'In case EdgeDB connection can\'t be established, retry up to WAIT_TIME (e.g. \'30s\').
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l connect-timeout -d 'In case EdgeDB doesn\'t respond for a TIMEOUT, fail (or retry if [49m[39m[1m--wait-until-available[0m is also specified). Default \'10s\'.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l to-nightly -d 'Check the upgrade to a latest nightly version
'
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l to-testing -d 'Check the upgrade to a latest testing version
'
...
'
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l password -d 'Ask for password on the terminal (TTY)
'
...
'
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l password-from-stdin -d 'Read the password from stdin rather than TTY (useful for scripts)
'
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l tls-verify-hostname -d 'Verify hostname of the server using provided certificate

It\'s useful when certificate authority (CA) is used for handling certificate and usually not used for self-signed certificates.

By default it\'s enabled when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file)
'
complete -c edgedb -n "__fish_seen_subcommand_from migration; and __fish_seen_subcommand_from upgrade-check" -l no-tls-verify-hostname -d 'Do not verify hostname of the server
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -s H -l host -d 'Host of the EdgeDB instance
' -r -f -a "(__fish_print_hostnames)"
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -l unix-path -d 'A path to a unix socket for the EdgeDB connection

When the supplied path is a directory, the actual path will be computed using the [49m[39m[1m--port[0m and [49m[39m[1m--admin[0m parameters.
' -r -F
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -s u -l user -d 'User name of the EdgeDB user
' -r
...
This might either be full self-signed server certificate or certificate authority (CA) certificate that server certificate is signed with.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -l tls-security -d 'Specify the client-side TLS security mode.
...
[49m[39m[1mdefault[0m: By default it\'s "strict" when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file), or "no_host_verification" otherwise.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -l wait-until-available -d 'In case EdgeDB connection can\'t be established, retry up to WAIT_TIME (e.g. \'30s\').
' -r
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -l password -d 'Ask for password on the terminal (TTY)
'
...
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -l tls-verify-hostname -d 'Verify hostname of the server using provided certificate

It\'s useful when certificate authority (CA) is used for handling certificate and usually not used for self-signed certificates.

By default it\'s enabled when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file)
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -l no-tls-verify-hostname -d 'Do not verify hostname of the server
...
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -f -a "create" -d 'Create a new DB
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -f -a "drop" -d 'Delete the database
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from drop; and not __fish_seen_subcommand_from wipe; and not __fish_seen_subcommand_from help" -f -a "wipe" -d 'Destroy the contents of the current database (keeping database itself)
'
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from drop" -s H -l host -d 'Host of the EdgeDB instance
' -r -f -a "(__fish_print_hostnames)"
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from drop" -l unix-path -d 'A path to a unix socket for the EdgeDB connection

When the supplied path is a directory, the actual path will be computed using the [49m[39m[1m--port[0m and [49m[39m[1m--admin[0m parameters.
' -r -F
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from drop" -s u -l user -d 'User name of the EdgeDB user
' -r
...
This might either be full self-signed server certificate or certificate authority (CA) certificate that server certificate is signed with.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from drop" -l tls-security -d 'Specify the client-side TLS security mode.
...
[49m[39m[1mdefault[0m: By default it\'s "strict" when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file), or "no_host_verification" otherwise.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from drop" -l wait-until-available -d 'In case EdgeDB connection can\'t be established, retry up to WAIT_TIME (e.g. \'30s\').
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from drop" -l connect-timeout -d 'In case EdgeDB doesn\'t respond for a TIMEOUT, fail (or retry if [49m[39m[1m--wait-until-available[0m is also specified). Default \'10s\'.
' -r
...
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from drop" -l password -d 'Ask for password on the terminal (TTY)
'
...
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from drop" -l password-from-stdin -d 'Read the password from stdin rather than TTY (useful for scripts)
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from drop" -l tls-verify-hostname -d 'Verify hostname of the server using provided certificate

It\'s useful when certificate authority (CA) is used for handling certificate and usually not used for self-signed certificates.

By default it\'s enabled when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file)
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from drop" -l no-tls-verify-hostname -d 'Do not verify hostname of the server
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from wipe" -s H -l host -d 'Host of the EdgeDB instance
' -r -f -a "(__fish_print_hostnames)"
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from wipe" -l unix-path -d 'A path to a unix socket for the EdgeDB connection

When the supplied path is a directory, the actual path will be computed using the [49m[39m[1m--port[0m and [49m[39m[1m--admin[0m parameters.
' -r -F
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from wipe" -s u -l user -d 'User name of the EdgeDB user
' -r
...
This might either be full self-signed server certificate or certificate authority (CA) certificate that server certificate is signed with.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from wipe" -l tls-security -d 'Specify the client-side TLS security mode.
...
[49m[39m[1mdefault[0m: By default it\'s "strict" when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file), or "no_host_verification" otherwise.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from wipe" -l wait-until-available -d 'In case EdgeDB connection can\'t be established, retry up to WAIT_TIME (e.g. \'30s\').
' -r
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from wipe" -l connect-timeout -d 'In case EdgeDB doesn\'t respond for a TIMEOUT, fail (or retry if [49m[39m[1m--wait-until-available[0m is also specified). Default \'10s\'.
' -r
...
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from wipe" -l password -d 'Ask for password on the terminal (TTY)
'
...
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from wipe" -l password-from-stdin -d 'Read the password from stdin rather than TTY (useful for scripts)
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from wipe" -l tls-verify-hostname -d 'Verify hostname of the server using provided certificate

It\'s useful when certificate authority (CA) is used for handling certificate and usually not used for self-signed certificates.

By default it\'s enabled when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file)
'
complete -c edgedb -n "__fish_seen_subcommand_from database; and __fish_seen_subcommand_from wipe" -l no-tls-verify-hostname -d 'Do not verify hostname of the server
...
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l debug-output-file -d 'Write analysis into the JSON file specified instead of formatting
' -r
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -s H -l host -d 'Host of the EdgeDB instance
' -r -f -a "(__fish_print_hostnames)"
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -s P -l port -d 'Port to connect to EdgeDB
' -r
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l unix-path -d 'A path to a unix socket for the EdgeDB connection

When the supplied path is a directory, the actual path will be computed using the [49m[39m[1m--port[0m and [49m[39m[1m--admin[0m parameters.
' -r -F
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -s u -l user -d 'User name of the EdgeDB user
' -r
...
This might either be full self-signed server certificate or certificate authority (CA) certificate that server certificate is signed with.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l tls-security -d 'Specify the client-side TLS security mode.
...
[49m[39m[1mdefault[0m: By default it\'s "strict" when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file), or "no_host_verification" otherwise.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l wait-until-available -d 'In case EdgeDB connection can\'t be established, retry up to WAIT_TIME (e.g. \'30s\').
' -r
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l connect-timeout -d 'In case EdgeDB doesn\'t respond for a TIMEOUT, fail (or retry if [49m[39m[1m--wait-until-available[0m is also specified). Default \'10s\'.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l expand -d 'Show detailed output of the analyze
'
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l password -d 'Ask for password on the terminal (TTY)
'
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l no-password -d 'Don\'t ask for password
'
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l password-from-stdin -d 'Read the password from stdin rather than TTY (useful for scripts)
'
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l tls-verify-hostname -d 'Verify hostname of the server using provided certificate

It\'s useful when certificate authority (CA) is used for handling certificate and usually not used for self-signed certificates.

By default it\'s enabled when no specific certificate is present (via [49m[39m[1m--tls-ca-file[0m or in credentials JSON file)
'
complete -c edgedb -n "__fish_seen_subcommand_from analyze" -l no-tls-verify-hostname -d 'Do not verify hostname of the server
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from ui" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from ui" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from ui" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from project; and __fish_seen_subcommand_from init" -s d -l database -d 'Specifies the default database for the project to use on that instance
' -r
...
' -r -f -a "{auto	,manual	}"
complete -c edgedb -n "__fish_seen_subcommand_from project; and __fish_seen_subcommand_from init" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from project; and __fish_seen_subcommand_from init" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from project; and __fish_seen_subcommand_from init" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
' -r -f -a "(__fish_complete_directories)"
complete -c edgedb -n "__fish_seen_subcommand_from project; and __fish_seen_subcommand_from unlink" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from project; and __fish_seen_subcommand_from unlink" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from project; and __fish_seen_subcommand_from unlink" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from create" -l region -d 'For cloud instances: the region to create the instance in.
' -r
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from create" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from create" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from create" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from list" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from list" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from list" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
' -r -f
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from status" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from status" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from status" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
' -r -f
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from destroy" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from destroy" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from destroy" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from link" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from link" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from link" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from upgrade" -l to-channel -d 'Upgrade specified instance to the latest version in the channel
' -r -f -a "{stable	,testing	,nightly	}"
...
' -r -f
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from upgrade" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from upgrade" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from upgrade" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
'
complete -c edgedb -n "__fish_seen_subcommand_from instance; and __fish_seen_subcommand_from upgrade" -l non-interactive -d 'Do not ask questions, assume user wants to create instance
'
...
complete -c edgedb -n "__fish_seen_subcommand_from cli; and __fish_seen_subcommand_from upgrade" -l to-channel -d 'Upgrade specified instance to the specified channel
' -r -f -a "{stable	,testing	,nightly	}"
...
'
complete -c edgedb -n "__fish_seen_subcommand_from cli; and __fish_seen_subcommand_from upgrade" -l to-testing -d 'Upgrade to the latest testing version
'
...
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from logout; and not __fish_seen_subcommand_from secretkey; and not __fish_seen_subcommand_from help" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from logout; and not __fish_seen_subcommand_from secretkey; and not __fish_seen_subcommand_from help" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from logout; and not __fish_seen_subcommand_from secretkey; and not __fish_seen_subcommand_from help" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and not __fish_seen_subcommand_from login; and not __fish_seen_subcommand_from logout; and not __fish_seen_subcommand_from secretkey; and not __fish_seen_subcommand_from help" -f -a "login" -d 'Authenticate to the EdgeDB Cloud and remember the secret key locally
'
...
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from login" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from login" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from login" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from logout" -l all-profiles -d 'Logout from all Cloud profiles
'
...
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from list" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from list" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from list" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from create" -l expires -d 'Key expiration, in duration units, for example "1 hour 30 minutes". If set to "never", the key would not expire.
' -r
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from create" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from create" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from create" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from revoke" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from revoke" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from revoke" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r
...
'
complete -c edgedb -n "__fish_seen_subcommand_from cloud; and __fish_seen_subcommand_from secretkey; and __fish_seen_subcommand_from revoke" -s y -l non-interactive -d 'Revoke the key without asking for confirmation.
'
...
complete -c edgedb -n "__fish_seen_subcommand_from watch" -l cloud-api-endpoint -d 'Specify the EdgeDB Cloud API endpoint, default to the current logged-in server, or https://api.g.aws.edgedb.cloud if unauthorized
' -r
complete -c edgedb -n "__fish_seen_subcommand_from watch" -l cloud-secret-key -d 'Specify the EdgeDB Cloud API secret key to use, instead of loading the secret key from the remembered authentication.
' -r
complete -c edgedb -n "__fish_seen_subcommand_from watch" -l cloud-profile -d 'Specify the authenticated EdgeDB Cloud profile, default is "default".
' -r

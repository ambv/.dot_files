...
PROMPT_TEMPLATE="%{$PS_USERCOLOR%}%n%{$PS_ATCOLOR%}@%{$PS_HOSTCOLOR%}%m%{$PS_COLONCOLOR%}:%{$PS_PATHCOLOR%}%~%{$PS_PROMPTCOLOR%} $ %{$PS_NOCOLOR%}"
...
alias alias='true'   # ignore aliases in /etc/zshrc and /etc/profile.d/*
